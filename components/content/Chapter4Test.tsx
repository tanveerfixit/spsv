...
import { chapter4Questions } from '@/lib/data/chapter4Questions';
...
export default function Chapter4Test() {
  ...
  const startNewTest = () => {
    ...
    const shuffledQuestions = shuffleArray(chapter4Questions).map((q: any) => ({
      ...q,
    ...
    <div className="max-w-3xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-2">
        <div className="flex items-center gap-2">
          <h2 className="text-sm font-bold text-gray-900 dark:text-white uppercase tracking-tight">Chapter 4 Test</h2>
